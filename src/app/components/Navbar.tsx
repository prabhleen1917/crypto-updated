  ...
  return (
    <div className="z-10 fixed px-10 md:px-0 bg-secondary h-28 w-full md:h-screen md:w-52 md:flex md:flex-col">
      <div className="flex md:block">
        <Link href="/" passHref>
          ...
          <svg viewBox='0 0 675 375' xmlns='http://www.w3.org/2000/svg' className="w-32 h-12" fill='none'>
            ...
            <span className="flex items-center h-16 text-xl font-bold text-indigo-50/70 hover:text-indigo-50">
              CryptoPlace
            </span>
          </div>
        </Link>
      ...
      <nav className="flex justify-between md:justify-start md:flex-col text-indigo-50/70 flex-1 w-full text-lg md:mt-32">
        <Link href="/cryptos" passHref>
          <div className="md:pl-5 mb-6 flex justify-start items-center hover:text-indigo-50 md:hover:border-r-4 hover:border-indigo-500">
            <BiBitcoin size={20} className="mr-2" />
            <span className="inline-block">Top 50 Crypto</span>
          </div>
        </Link>
        ...
        {/* <Link href="/watchlist" passHref>
          <div className="md:pl-5 mb-6 flex justify-start items-center ">
            <VscEye size={20} className="mr-2" />
            <span className="inline-block">Watchlist</span>
          </div>
        </Link> */}
